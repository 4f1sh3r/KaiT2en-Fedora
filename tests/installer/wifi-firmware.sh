...
run_case bcm4364 4364b3 trinidad X3 HRPN u 7.7
run_case bcm4377 4377b3 bali X0 HRPN u 8.0
# Macs whose macOS files carry no antenna variant at all.
run_case bcm4364gen 4364b3 kauai '' HRPN u 7.5
