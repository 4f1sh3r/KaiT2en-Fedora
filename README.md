...
Read the [automatic installation howto](https://kait2en.github.io/howto/installation/automatic/) before
you start. For all installation paths, start with the
[installation introduction](https://kait2en.github.io/howto/introduction/).

Useful paths:

- [Automatic installation](https://kait2en.github.io/howto/installation/automatic/)
- [Manual installation](https://kait2en.github.io/howto/installation/manual/00-get-broadcom-firmware/)
- [Revert T2 Linux Fedora to vanilla Fedora + KAIT2EN](https://kait2en.github.io/howto/migration/revert-t2linux-fedora/)
- [Updating KAIT2EN](https://kait2en.github.io/howto/postinstall/updating/)
...
- MacBook Pro A1990 15,1: resume is broken when running with the dGPU as primary
  GPU. See the [GPU configuration guide](https://kait2en.github.io/howto/postinstall/configuring-gpus/).
...
- A fork of `apple-t2-audio-dsp` for supported Macs.
  See [supported devices](https://kait2en.github.io/howto/installation/manual/03-install-kait2en-modules-and-apps/#apple-t2-audio-dsp).
