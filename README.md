...
The kernel modules are GPL-2.0; everything else KAIT2EN writes, apps, protocols,
audio DSP profiles and scripts, is GPL-3.0-or-later. The full breakdown is in
